...
class ModerateUsers extends StatefulWidget {
  final List<DocumentSnapshot> moderatelist;
  const ModerateUsers({super.key, required this.moderatelist});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: widget.moderatelist.length,
        itemBuilder: (context, index) {
          DocumentSnapshot doc = widget.moderatelist[index];
